...
namespace SpacedInvaders
{
	class Defender : TokenGeneral
	{
		...
		internal Defender(PointF startLocation)
		{
			...
			sprite = Bitmap.FromFile ("C:/Users/voxpl/Desktop/SpaceInvaders_Prototype/pictures/ship.png");
		...
		internal override void Step(double elapsed)
		{
			switch (Global.DefenderDirection)
			{
				...
				case Directions.Left:
					sprite = Bitmap.FromFile("C:/Users/voxpl/Desktop/SpaceInvaders_Prototype/pictures/ship_Left.png");
				...
				case Directions.Right:
					sprite = Bitmap.FromFile("C:/Users/voxpl/Desktop/SpaceInvaders_Prototype/pictures/ship_Right.png");
					location.X += (float)(elapsed * Global.DefenderSpeed);
				...
				case Directions.Down:
					sprite = Bitmap.FromFile("C:/Users/voxpl/Desktop/SpaceInvaders_Prototype/pictures/ship_Down.png");
