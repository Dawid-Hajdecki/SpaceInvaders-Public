...
namespace SpacedInvaders
{
    class Alien : TokenGeneral
    {
		...
		internal Alien(PointF startLocation)
        {
            ...
            sprite = Bitmap.FromFile("C:/Users/voxpl/Desktop/SpaceInvaders_Prototype/pictures/Alien.png");
		...
		{
			dead = true;
			sprite = Bitmap.FromFile("C:/Users/voxpl/Desktop/SpaceInvaders_Prototype/pictures/Alien3_transparent.png");
			Global.Score += 10;
		}
